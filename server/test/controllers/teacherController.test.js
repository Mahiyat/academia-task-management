...
describe('Teacher Controller', () => {
  ...
  describe('getAllTeachers', () => {
    it('should retrieve all teachers with populated courses and return them in the response', async () => {
    ...
    it('should return a 500 status code and an error message if an error occurs', async () => {
      ...
      sinon.stub(teacherServices, 'getAllTeachers').throws(new Error(errorMessage));
